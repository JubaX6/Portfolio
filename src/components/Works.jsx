...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
            {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${phpDBIcon})` }}
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <p className='text-center'>This is a PHP Website with a mySQL database for the Backend</p>
              <div className='pt-8 text-center'>
                <a href='https://github.com/JubaX6/A2COMP353/'
                target='_blank'>
